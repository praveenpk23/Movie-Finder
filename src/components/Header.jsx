...
const Header = () => {
  ...
  return (
   <div className="fixed " style={{width:"100%",zIndex:"1000" , marginBottom:"50px"}}>
          ...
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li>
              <NavLink to="movies/popular" 
                // className={({isActive})=>{isActive ? activeClass : inactiveClass }}
                className={({isActive})=>{if(isActive){return activeClass}else{return inactiveClass}}}
              >
                Popular
              </NavLink>
            </li>
            ...
            <li>
              <NavLink
                to="/movies/upcoming"
                className={({isActive})=>{ return isActive ? activeClass : inactiveClass} }
