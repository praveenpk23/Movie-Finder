...
<div className="flex items-center justify-center min-h-screen">
  <div role="status">
    ...
    <section className="max-w-7xl mx-auto py-7">
      <div className="pb-5">
        {movies.length === 0 ? (
                <p className='text-3xl text-center'> No result found for <span className='text-red-500'>({query})</span> </p>
        ):(
                <p className='text-3xl '> Result for ('<span className='text-green-500'>{query}</span>') </p>
        )}
      </div>
